...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        ...
        packagesTableBody.addEventListener('click', function(e) {
            if (e.target.closest('.delete-package')) {
                const button = e.target.closest('.delete-package');
    ...
    function updateBulkActionButton() {
        if (applyBulkActionBtn) {
            applyBulkActionBtn.disabled = selectedPackages.size === 0 || !bulkActionSelect.value;
        }
    }
    ...
    function setupDeleteModal() {
        if (deletePackageModal) {
            ...
            deletePackageModal.querySelector('.modal-overlay').addEventListener('click', hideDeleteModal);
            
            // Close modal khi click close button
            deletePackageModal.querySelector('.modal-close').addEventListener('click', hideDeleteModal);
            
            // Cancel button
            deletePackageModal.querySelector('.cancel-btn').addEventListener('click', hideDeleteModal);
    ...
    function confirmDeletePackage() {
        ...
        const packageName = document.getElementById('deletePackageName').textContent;
