...
// User Growth
	...
	fetch('/admin/statistics/user-growth')
	    ...
	    .catch(error => {
	        console.error('Lỗi khi load dữ liệu người dùng theo tháng:', error);
	    });
	...
	function loadRevenueData(months = 6) { 
	    fetch(`/admin/statistics/revenue-monthly?months=${months}`)
	        .then(res => res.json())
	        .then(data => {
